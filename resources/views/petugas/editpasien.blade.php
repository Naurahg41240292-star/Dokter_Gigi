...
<head>
    ...
    <title>Edit Data Pasien - D'Smile Dental Clinic</title>
...
<body class="flex">
    ...
    <main class="flex-1 ml-[260px] p-6 lg:p-8">
        ...
        <header class="-mx-6 lg:-mx-8 -mt-6 lg:-mt-8 px-6 lg:px-8 pt-6 pb-5 mb-8 bg-white border-b border-slate-100 flex justify-between items-center">
            ...
            <a href="{{ route('petugas.data-pasien') }}" class="text-slate-500 hover:text-slate-700 text-sm font-medium flex items-center gap-2">
            ...
            <form action="{{ route('petugas.update-pasien', $pasien->id) }}" method="POST">
                ...
                <div class="mb-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                           <label class="...">NIK (No. KTP) <span class="text-red-500">*</span></label>
                        <input type="text" name="nik" value="{{ old('nik', $pasien->nik) }}" required class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500" placeholder="Masukkan 16 digit NIK pasien">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">Tanggal Lahir</label>
                            <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $pasien->tanggal_lahir) }}" class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 text-slate-600">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-2">Jenis Kelamin</label>
                            <div class="flex items-center gap-6 mt-2.5">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" name="jenis_kelamin" value="Laki-laki" {{ old('jenis_kelamin', $pasien->jenis_kelamin) == 'Laki-laki' ? 'checked' : '' }} class="w-4 h-4 text-primary-600">
                                    <span class="text-sm text-slate-700">Laki-laki</span>
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="radio" name="jenis_kelamin" value="Perempuan" {{ old('jenis_kelamin', $pasien->jenis_kelamin) == 'Perempuan' ? 'checked' : '' }} class="w-4 h-4 text-primary-600">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="alamat" rows="3" class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none">{{ old('alamat', $pasien->alamat) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="riwayat_penyakit" rows="3" class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none">{{ old('riwayat_penyakit', $pasien->riwayat_penyakit) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="kontak_nama" value="{{ old('kontak_nama', $pasien->kontak_nama) }}" class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="tel" name="kontak_telepon" value="{{ old('kontak_telepon', $pasien->kontak_telepon) }}" class="w-full border border-slate-200 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">
                        </div>
                    </div>
                </div>
