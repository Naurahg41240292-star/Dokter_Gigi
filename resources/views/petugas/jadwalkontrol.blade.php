                        ...
                        <div class="max-h-72 overflow-y-auto divide-y divide-slate-50">
                            <a href="#" class="block px-5 py-3.5 hover:bg-slate-50 transition relative">
                                <div class="flex gap-3">
                                    <div class="w-9 h-9 bg-amber-50 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5"><i class="fas fa-calendar-check text-amber-600 text-xs"></i></div>
                                    <div>
                                        <p class="text-xs font-semibold text-slate-800">Janji Temu 1 Jam Lagi</p>
                                        <p class="text-[11px] text-slate-500 mt-0.5">Budi Santoso memiliki jadwal scalling pukul 10.00.</p>
                                        <p class="text-[10px] text-slate-400 mt-1.5 font-medium">30 menit yang lalu</p>
                                    </div>
                                </div>
